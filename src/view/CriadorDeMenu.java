...
public class CriadorDeMenu {
	...
	private static JMenuItem criaSubMenuComAction(String nome, ActionListener action) {
		JMenuItem subMenu = new JMenuItem(nome);
		subMenu.addActionListener(action);
		return subMenu;
	}
	
	public static JMenu criaMenuComSubMenu(String nomeMenu, Map<String, ActionListener> subMenuComAction) {
